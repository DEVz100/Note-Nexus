...
if(!isBME){
    $.getJSON("./assets/nom2.json", function (data) {
        ...
        selectedSem.forEach(el => {
            ...
            if (el === sub_id) {
                document.getElementById("sub-drop-cont").innerHTML += ` <a class="dropdown-item active" href="./notes2.html?id=${el}">
                ...
                if(data.EL[el] != null)
                document.getElementById("sub-drop-cont").innerHTML += ` <a class="dropdown-item" href="./notes2.html?id=${el}">
    ...
    document.getElementById("sem-title").setAttribute("href","./semester2.html?id=BME")
...
let SylLink = "./assets/BMEsyll.json";

if(!isBME ){
    SylLink = "./assets/course2.json";
}
